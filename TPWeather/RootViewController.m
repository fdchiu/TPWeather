...
- (IBAction)refresh:(id)sender {
    ...
    if ([self.modelController.dataController syncing]) {
        return;
    }
...
#pragma mark - network
// utility function to check availability of network
// and display warning when the web site to get randoom number is not available
-(BOOL)networkReachable
{
    Reachability *r = [Reachability reachabilityWithHostName:@"api.openweathermap.org"];
    ...
    if(internetStatus == NotReachable)
    {
        if(TRUE) {
            UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"No Internet Connection"
                                                                                     message:@"Cannot reach api.openweathermap.org"
